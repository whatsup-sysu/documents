...
| 制品       |   工作内容    | huangjundashuaige | wkfdb | huntingwolf320 | zhangziquan |
| ---------- | ------------------------------------------------------------ | ---- | ------ | ------ | ------ |
| 源代码     | 项目代码。<br />[source_code](https://github.com/whatsup-sysu)| 15% | 30% | 25%    | 20%    |
| 项目文档   | [文档](https://github.com/whatsup-sysu/documents)             | 30% | 10% | 15%   | 5%     |
| 分析与设计 | UI设计/数据库设计/api设计/架构设计                              | 30% | 30% | 30%   | 20%    |
| 需求/测试| 前期调研/正确性测试/压力测试                                      | 25% | 30% | 30%   |          |
| 综合贡献   |                                                              | 25%  | 25% | 25%    | 17%    |
...
|      项目      | huangjundashuaige | wkfdb | huntingwolf320 | zhangziquan |
| :------------: | :--: | :----: | :----: | :----: |
|      计划      |   24   |   11   |    10    |   10     |
| * 估计任务时间 |   24  |   11   |    10    |    10    |
|      开发      |   62   |   84   |    70    |   80     |

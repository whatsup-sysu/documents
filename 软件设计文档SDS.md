<!-- vscode-markdown-toc -->
* 1. [UI设计文档](#UI)
	* 1.1. [UI Design](#UIDesign)
		* 1.1.1. [Use case 1](#Usecase1)
		* 1.1.2. [Version 0.1 (Week 3 ~ Week 6)](#Version0.1Week3Week6)
		* 1.1.3. [组件设计思路](#)
		* 1.1.4. [自评](#-1)
	* 1.2. [Version 0.2 (Week 7 ~ Now)](#Version0.2Week7Now)
		* 1.2.1. [总览](#-1)
* 2. [数据库模式设计](#-1)
* 3. [API设计](#API)
	* 3.1. [用户注册](#-1)
...
###  1.1. <a name='UIDesign'></a>UI Design

####  1.1.1. <a name='Usecase1'></a>Use case 1

![](https://raw.githubusercontent.com/rookies-sysu/Dashboard/master/imgs/usecase/UC1_ui.png)

---

####  1.1.2. <a name='Version0.1Week3Week6'></a>Version 0.1 (Week 3 ~ Week 6)
...
###  1.2. <a name='Version0.2Week7Now'></a>Version 0.2 (Week 7 ~ Now)
...
####  3.2.1. <a name='-1'></a>参数说明

| 参数名 | 数据类型 | 描述         | 必须 |
| ------ | -------- | ------------ | ---- |
| code   | string   | 登录凭证 | 是   |

####  3.2.2. <a name='-1'></a>返回值
